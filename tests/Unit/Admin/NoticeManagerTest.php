...
use LightweightPlugins\SEO\Admin\NoticeManager;
use LightweightPlugins\SEO\Tests\Unit\MonkeyTestCase;
use Mockery\Adapter\Phpunit\MockeryPHPUnitIntegration;

final class NoticeManagerTest extends MonkeyTestCase {

	// Counts the expect() calls as assertions. Kept out of MonkeyTestCase:
	// there it would flag the suite's expectNotToPerformAssertions() tests.
	...
	public static function callback_provider(): array {
		return [
			'LW static method string' => [ 'LightweightPlugins\\SEO\\Admin\\AdminNotice::render', true ],
		...
		$GLOBALS['wp_filter'] = [
			'admin_notices'     => (object) [
				'callbacks' => [
					10 => [
						'a' => [ 'function' => $foreign ],
						'b' => [ 'function' => 'LightweightPlugins\\SEO\\Admin\\AdminNotice::render' ],
					],
				],
			],
